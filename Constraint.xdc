...
# up
set_property PACKAGE_PIN T18 [get_ports select_UP]
    set_property IOSTANDARD LVCMOS33 [get_ports select_UP]
# down
set_property PACKAGE_PIN U17 [get_ports select_DOWN]
    set_property IOSTANDARD LVCMOS33 [get_ports select_DOWN]
# right
